...
## How it works
The perk picker looks at each individual level of your fighter and suggests the top perk in each level based on <span className="mention">@Kasito</span>’s scoring. Kasito scores with ranked play in mind.
