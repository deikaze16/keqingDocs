...
First, if you want to use this feature, you need to enable it in your server. How? If you are an admin, just run the `[p]dropwatch` command and then click the <button class="btn btn-success">Enable this feature</button> button
...
Format : 
- [p]adropaccess &lt;<span class="mention">@role</span> | false>
