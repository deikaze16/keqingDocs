...
<ul>
  ...
  <li>Developer: <b className="mention">@itsdei</b></li>
...
This documentation will help you, step by step, regarding each of <span className="mention">@Keqing</span>'s features. Please go through carefully to understand how this bot works.
...
2. You should see a prompt from Discord asking you if you want to allow <b className="mention">@Keqing Bot</b> to see your username and servers. Click Authorize.
...
### How to setup
In order to use this bot, you must grant these permissions to <span className="mention">@Keqing</span>
...
The documentation site should have everything you need to get <span className="mention">@Keqing</span> working. However, if you run into some issues, please reach out to us on our [Discord server](https://discord.gg/keqingbot).

## Supporting the bot

Our <span className="mention">@Keqing Bot</span> will always be a free-to-use service. However, for $2 / month, you can get some more features and better Quality of Life.

You can check out <span className="mention">@Keqing</span>'s premium on [this page](https://www.keqingbot.com/premium).